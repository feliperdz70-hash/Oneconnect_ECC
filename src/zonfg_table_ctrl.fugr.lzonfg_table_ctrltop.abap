FUNCTION-POOL ZONFG_TABLE_CTRL.                   "MESSAGE-ID ..
...
data: gt_dd07t type STANDARD TABLE OF dd07t,
      gs_dd07t type dd07t.


*---------Declaration of Table Control---------------------------------*
CONTROLS: priorities_tab TYPE TABLEVIEW USING SCREEN 200.
